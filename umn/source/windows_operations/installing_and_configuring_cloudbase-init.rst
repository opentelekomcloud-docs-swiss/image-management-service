...
#. Edit the configuration file **C:\\Program Files\\Cloudbase Solutions\\Cloudbase-Init\\conf\\cloudbase-init.conf** in the Cloudbase-Init installation path.
   ...
   c. Add **plugins** to configure the modules that will be loaded. Separate different modules with commas (,). The information in bold is the keyword of each module.
      ...
      -  **SetUserSSHPublicKeysPlugin** configures a private key.
