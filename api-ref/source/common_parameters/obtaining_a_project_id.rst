:original_name: en-us_topic_0121673684.html

.. _en-us_topic_0121673684:
...
-  :ref:`Obtain the Project ID by Calling an API <en-us_topic_0121673684__section86806471133>`
-  :ref:`Obtain the Project ID from the Console <en-us_topic_0121673684__section11508201712212>`

.. _en-us_topic_0121673684__section86806471133:
...
The API used to obtain a project ID is GET https://{Endpoint}/v3/projects. {Endpoint} is the IAM endpoint and can be obtained from `Regions and Endpoints <https://docs.sc.otc.t-systems.com/en-us/endpoint/index.html>`__. For details about API authentication, see :ref:`Authentication <en-us_topic_0121671869>`.
...
.. _en-us_topic_0121673684__section11508201712212:
